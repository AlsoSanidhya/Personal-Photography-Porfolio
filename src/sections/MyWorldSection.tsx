        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <FadeIn delay={0.05} className="md:col-span-2 md:row-span-2">
            <motion.a 
              ...
              className="group relative block h-[320px] sm:h-[400px] md:h-[450px] rounded-2xl bg-[#0A0A0A] border border-[#F5F1E8]/5 overflow-hidden transition-all duration-300"
            >
          ...
          <FadeIn delay={0.15}>
            <motion.a 
              ...
              transition={{ type: 'spring', stiffness: 300, damping: 20 }}
              className="group relative block h-[200px] sm:h-[210px] md:h-[210px] rounded-2xl bg-[#0A0A0A] border border-[#F5F1E8]/5 p-6 transition-all duration-300 overflow-hidden"
            >
              <div className="absolute top-6 left-6 p-3 bg-[#F5F1E8]/5 rounded-xl border border-[#F5F1E8]/10 text-[#8B5CF6] transition-colors duration-300 group-hover:bg-[#8B5CF6]/10">
          ...
          <FadeIn delay={0.25} className="md:col-span-1">
            <motion.a 
              ...
              whileHover={{ y: -6, scale: 1.02, borderColor: 'rgba(139, 92, 246, 0.3)', boxShadow: '0 20px 40px rgba(139, 92, 246, 0.08)' }}
              transition={{ type: 'spring', stiffness: 300, damping: 20 }}
              className="group relative block h-[200px] sm:h-[210px] md:h-[216px] rounded-2xl bg-[#0A0A0A] border border-[#F5F1E8]/5 p-6 transition-all duration-300 overflow-hidden"
            >
              <div className="absolute top-6 left-6 p-3 bg-[#F5F1E8]/5 rounded-xl border border-[#F5F1E8]/10 text-[#8B5CF6] transition-colors duration-300 group-hover:bg-[#8B5CF6]/10">
          ...
          <FadeIn delay={0.3}>
            <motion.a 
              ...
              whileHover={{ y: -6, scale: 1.02, borderColor: 'rgba(139, 92, 246, 0.3)', boxShadow: '0 20px 40px rgba(139, 92, 246, 0.08)' }}
              transition={{ type: 'spring', stiffness: 300, damping: 20 }}
              className="group relative block h-[200px] rounded-2xl bg-[#0A0A0A] border border-[#F5F1E8]/5 p-6 transition-all duration-300"
            >
              <div className="absolute top-6 left-6 p-3 bg-[#F5F1E8]/5 rounded-xl border border-[#F5F1E8]/10 text-[#8B5CF6] transition-colors duration-300 group-hover:bg-[#8B5CF6]/10">
          ...
          <FadeIn delay={0.35} className="md:col-span-2">
            <motion.a 
              ...
              whileHover={{ y: -6, scale: 1.01, borderColor: 'rgba(139, 92, 246, 0.3)', boxShadow: '0 20px 40px rgba(139, 92, 246, 0.08)' }}
              transition={{ type: 'spring', stiffness: 300, damping: 20 }}
              className="group relative block h-[200px] rounded-2xl bg-[#0A0A0A] border border-[#F5F1E8]/5 p-6 transition-all duration-300 overflow-hidden"
            >

...
import { Music, Dumbbell, ArrowUpRight } from 'lucide-react'
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <FadeIn delay={0.05} className="md:col-span-2 md:row-span-2">
            ...
            >
              <div className="absolute inset-0 bg-cover bg-center opacity-30 group-hover:opacity-45 transition-opacity duration-500" style={{ backgroundImage: `url('https://images.unsplash.com/photo-1517841905240-472988babdf9?w=800&auto=format&fit=crop&q=80')` }} />
          ...
          {/* Card 3: Gym & Lifestyle */}
          <FadeIn delay={0.25} className="md:col-span-1">
            <motion.a 
              href={gym.url} 
              target="_blank" 
              rel="noopener noreferrer"
              whileHover={{ y: -6, scale: 1.02, borderColor: 'rgba(244, 63, 94, 0.4)', boxShadow: '0 20px 40px rgba(244, 63, 94, 0.15)' }}
              transition={{ type: 'spring', stiffness: 300, damping: 20 }}
            ...
            >
              <div className="absolute top-6 left-6 p-3 bg-white/5 rounded-2xl backdrop-blur-md border border-white/10 text-rose-400 transition-colors duration-300 group-hover:bg-rose-400/10">
              ...
              <div className="absolute bottom-6 left-6">
                <span className="text-xs font-semibold tracking-widest text-rose-400 uppercase">Fitness & Energy</span>
                <h3 className="text-xl font-bold mt-1 mb-1">Gym & Lifestyle</h3>
                <p className="text-xs text-slate-400">{gym.handle} — tracking consistency, fitness goals, and aesthetic progress.</p>
              </div>
            </motion.a>
          </FadeIn>
